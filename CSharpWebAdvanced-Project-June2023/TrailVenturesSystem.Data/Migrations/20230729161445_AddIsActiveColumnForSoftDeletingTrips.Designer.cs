...
namespace TrailVenturesSystem.Data.Migrations
{
    ...
    [Migration("20230729161445_AddIsActiveColumnForSoftDeletingTrips")]
    partial class AddIsActiveColumnForSoftDeletingTrips
    {
            ...
            modelBuilder.Entity("TrailVenturesSystem.Data.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("743a8aa1-958a-4c30-9040-3f09979f2578"),
                        ...
                        new
                        {
                            Id = new Guid("f6a24648-fe1b-4040-afbe-6818f9197eba"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
